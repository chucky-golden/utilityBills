        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Data 9mobile</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-12 mt-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Data 9mobile</h5>
                            ...
                            <form class="row g-3 mb-5" id="data-form">
                                ...
                                <input type="hidden" name="" id="plan" value="etisalat-data"><br>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        async function fetchData() {
            try {
                const response = await fetch('https://api-service.vtpass.com/api/service-variations?serviceID=etisalat-data', {
                    method: 'GET',
                    headers: {
                        'api-key': apiKey,
