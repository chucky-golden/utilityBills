              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter new password to reset <b>admin</b> account</p>
                  </div>

                  <form action="/admin/recover" method="POST" class="row g-3 needs-validation" novalidate>
