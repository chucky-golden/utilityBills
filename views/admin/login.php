              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter <b>admin</b> email & password to log in to account</p>
                  </div>
                  ...
                  <form action="/admin/login" method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12 mt-3">
                      <p class="small mb-0">don't have an account? <a href="/admin/register">Create now</a></p>
                    </div>
                  </form>
