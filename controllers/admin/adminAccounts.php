                    ...
                    if($check > 0){
                        ...
                        $msg = '
                            ...
                            <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0;">
                                ...
                                <a href="https://www.billzhub.com/admin/recover?email='.$email.'" style="background-color: #2828a7; color: #fff; border: none; padding: 15px; font-size: 16px; border-radius: 5px; cursor: pointer; text-decoration: none;">Password reset</a><br><br>
